...
class starter {
	public static void main(String args[]) throws Exception {
		...
		int q = 0;
		for(int x = 0; x<passwords.length; x++){
		    String y = (passwords[x].substring(q, q+1));
		    if(y.equals("!")||y.equals("@")||y.equals("#")||y.equals("$")||y.equals("%")||y.equals("^")||y.equals("&")||y.equals("*")){
		        count2++;
		        countTotal++;
		    }
		    else{
	...
	System.out.println("Amount of passwords over 8 characters: "+count1);
    System.out.println("Amount of passwords containing ! @ # $ % ^ & *: "+count2);
